...
void update_amps(
  ...
  t1_new -= 2 * tmp_2d.contract(t1, contraction_dims_1d).shuffle(shuffle_idx_2d);
...
// t1new += 2*np.einsum('kc,kica->ia', Fov, t2)
  contraction_dims_2d = {Eigen::IndexPair<int>(0,0), Eigen::IndexPair<int>(1,2)};
...
// t1new +=   np.einsum('kc,ic,ka->ia', Fov, t1, t1)
    ...
    contraction_dims_3d = {Eigen::IndexPair<int>(0,1), Eigen::IndexPair<int>(1,3), Eigen::IndexPair<int>(3,2)};
    t1_new += 2 * ovvv.contract(t2, contraction_dims_3d).shuffle(shuffle_idx_2d);

    // t1new +=  -lib.einsum('kcad,ikcd->ia', eris_ovvv, t2)
    contraction_dims_3d = {Eigen::IndexPair<int>(0,1), Eigen::IndexPair<int>(1,2), Eigen::IndexPair<int>(3,3)};
    ...
    contraction_dims_3d = {Eigen::IndexPair<int>(0,1), Eigen::IndexPair<int>(1,3), Eigen::IndexPair<int>(2,0)};
    t1_new -= 2 * ovoo.contract(t2, contraction_dims_3d);

    // t1new += lib.einsum("kcli,klac->ia", eris_ovoo, t2)
    contraction_dims_3d = {Eigen::IndexPair<int>(0,0), Eigen::IndexPair<int>(1,3), Eigen::IndexPair<int>(2,1)};
