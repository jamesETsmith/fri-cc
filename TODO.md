...
### Woooo
- [X] 1323 O^4V^2 `Wklij += lib.einsum('kcld,ijcd->klij', eris_ovov, t2)`
- [ ] `Wklij += lib.einsum('kcld,ic,jd->klij', eris_ovov, t1, t1)`

### Wvoov
- [X] 0112 O^3V^3 `Wakic -= 0.5*lib.einsum('ldkc,ilda->akic', eris_ovov, t2)`
- [X] 0313 O^3V^3 `Wakic -= 0.5*lib.einsum('lckd,ilad->akic', eris_ovov, t2)`
- [ ] `Wakic -= lib.einsum('ldkc,id,la->akic', eris_ovov, t1, t1)`

### Wovov
- [X] 0312 O^3V^3 `Wakci -= 0.5*lib.einsum('lckd,ilda->akci', eris_ovov, t2)`
